//
//  TopicLookQtype4TableViewCell.m
//  TyDtk
//
//  Created by 天一文化 on 16/7/12.
//  Copyright © 2016年 天一文化.王可佳. All rights reserved.
//

#import "TopicLookQtype4TableViewCell.h"
@interface TopicLookQtype4TableViewCell()<UIScrollViewDelegate,UIWebViewDelegate>
@property (nonatomic,strong) NSUserDefaults *tyUser;
@property (nonatomic,assign) CGFloat viewImageOy;
@property (nonatomic,strong) NSMutableArray *arrayImgUrl;
@end
@implementation TopicLookQtype4TableViewCell
...
- (void)setvalueForCellModel:(NSDictionary *)dic topicIndex:(NSInteger)index{
    ...
    answer = [NSString stringWithFormat:@"<table cellpadding ='0' cellspacing = '0' width = '100%%' align = 'center'>"
              "<tr>"
