//
//  AnalysisQtype4TableViewCell.m
//  TyDtk
//
//  Created by 天一文化 on 16/7/11.
//  Copyright © 2016年 天一文化.王可佳. All rights reserved.
//

#import "AnalysisQtype4TableViewCell.h"
@interface AnalysisQtype4TableViewCell()<UIScrollViewDelegate,UIWebViewDelegate>
@property (nonatomic,strong) NSUserDefaults *tyUser;
@property (nonatomic,assign) CGFloat viewImageOy;
////////////////////////////
@property (nonatomic,strong) NSMutableArray *arrayImgUrl;
@end
@implementation AnalysisQtype4TableViewCell
...
- (void)setvalueForCellModel:(NSDictionary *)dic topicIndex:(NSInteger)index{
    ...
    NSString *answerT = dic[@"answer"];
    answerT = [answerT stringByReplacingOccurrencesOfString:@"<br />" withString:@"\r\n"];
    
    NSString *answerU = dic[@"userAnswer"];
    answerU = [answerU stringByReplacingOccurrencesOfString:@"<br />" withString:@"\r\n"];
    if (levelTopic == 0) {
        userDo = [NSString stringWithFormat:@"<p>答题状态：<font color = 'red'>未作答</font></p>"
                  "<table cellpadding ='0' cellspacing = '0' width = '100%%' align = 'center'>"
                  "<tr>"
                  "<td width = '50px'><font size='2' height = '30px'>你的答案:</font></td><td align = 'left'><font color = 'red' size = '2'>未作答</font></td>"
                  "</tr>"
                  "<tr>"
                  "<td height = '50px' valign = 'top'><font size='2'>正确答案：</font>"
                  "</td>"
                  "<td align = 'left' valign = 'top'>"
                  "<textarea readonly = 'readonly' style='height:100%%;width:100%%;color:purple;font-size:14px;resize: none;border-radius:3px;'>"
                  "%@"
                  "</textarea>"
                  "</td>"
                  "</tr>"
        ...
        userDo = [NSString stringWithFormat:@"<p>答题状态：<font color = 'purple'>答题正确</font></p>"
                  "<table cellpadding ='0' cellspacing = '0' width = '100%%' align = 'center'>"
                  "<tr>"
                  "<td height = '50px' valign = 'top'><font size='2'>你的答案:</font></td><td align = 'left' valign = 'top'>"
                  "<textarea readonly = 'readonly' style='height:100%%;width:100%%;color:purple;font-size:14px;resize: none;border-radius:3px;'>"
                  "%@"
                  "</textarea>"
                  "</td>"
                  ...
                  "</td>"
                  "</tr>"
                  "</table><br/>",answerU,answerT];
    }
    else if (levelTopic == 2){
        userDo = [NSString stringWithFormat:@"<p>答题状态：<font color = 'red'>答题错误</font></p>"
                  "<table cellpadding ='0' cellspacing = '0' width = '100%%' align = 'center'>"
                  "<tr>"
                  "<td height = '50px' valign = 'top'><font size='2'>你的答案:</font></td><td align = 'left' valign = 'top'>"
                  "<textarea readonly = 'readonly' style='height:100%%;width:100%%;color:red;font-size:14px;resize: none;border-radius:3px;'>"
                  "%@"
                  "</textarea>"
                  "</td>"
                  "</tr>"
